...
import { BadgeDollarSign, Lightbulb } from "lucide-react";
      ...
      <div className="p-5 flex-1 flex flex-col">
        <div className="flex items-start gap-3 mb-4">
          <div className="w-10 h-10 flex items-center justify-center flex-shrink-0">
            <Lightbulb className="w-5 h-5 text-[#795548]" strokeWidth={1.75} aria-hidden="true" />
          </div>
        ...
        <div className="mt-auto pt-4 border-t border-[#795548]/20">
          <div className="flex items-center gap-3 bg-white/50 rounded-2xl p-4">
            <div className="w-10 h-10 flex items-center justify-center flex-shrink-0 bg-white rounded-full">
              <BadgeDollarSign className="w-5 h-5 text-[#795548]" strokeWidth={1.75} aria-hidden="true" />
            </div>
            <div>
