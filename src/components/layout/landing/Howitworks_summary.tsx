  ...
  return (
    <section className="w-full bg-[#00450d] px-4 py-14 sm:px-8 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-6xl">
        <motion.div
          className="mb-10 flex flex-col items-center gap-5 text-center sm:mb-14 lg:mb-20 lg:flex-row lg:items-start lg:justify-between lg:text-left"
          ...
          <div className="grid grid-cols-1 gap-10 sm:gap-12 md:grid-cols-3 md:gap-8">
            {steps.map((step, index) => (
              <motion.article
                ...
                transition={{ duration: 0.65, delay: index * 0.24, ease: [0.22, 1, 0.36, 1] }}
