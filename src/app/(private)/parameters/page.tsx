...
const metrics = [
  {
    icon: <Droplet className="h-5 w-5 text-[#00450D]" />,
    iconBg: "bg-[#00450d1a]",
  ...
  {
    icon: <Diamond className="h-5 w-5 text-[#7A5649]" />,
    iconBg: "bg-[#fdcdbc4c]",
  ...
  {
    icon: <Clover className="h-5 w-5 text-[#003E63]" />,
    iconBg: "bg-[#cee5ff]",
    title: "NPK Vitality",
    description:
  ...
  return (
    <div className="min-h-screen bg-[#EFF6E7]">
      ...
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 p-4 md:p-6">
        ...
        <div className="w-full lg:w-95 flex flex-col gap-6 lg:gap-8">
          <div className="relative h-52 sm:h-56 md:h-60 lg:h-64 rounded-[48px] overflow-hidden shadow-[0px_25px_50px_-12px_#00000040]">
            <Image
              src="/soil/soildatabg.png"
              alt="Soil and crop growth"
              fill
              className="object-cover object-center"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent" />
            <div className="absolute inset-x-0 bottom-0 p-6">
              <p className="font-medium text-white text-xs leading-4 drop-shadow-sm">
